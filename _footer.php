    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Akun Anda <b></b> Akan keluar dan kembali ke menu login. </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Tidak</button>
                    <a class="btn btn-primary btn-sm" href="../auth/logout.php">Yakin</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../_assets/js/demo/datatables-demo.js"></script>
</body>
